...
function Successful() {
  ...
  useEffect(() => {
    ...
    // console.log(paramObj.extraData);
    // console.log("decode", Base64.decode(paramObj.extraData));
    // const decodeStr = Base64.decode(paramObj.extraData)
            ...
            <div className={styles.content}>
              ...
              <ul className={styles.billInfo}>
                ...
                <li className={styles.billInfoItem}>
                  ...
                  <span>{dataURL.extraData.address}</span>
                </li>
                <li className={styles.billInfoItem}>
                  <p>Tổng tiền thanh toán</p>
                  <span>{CurrencyFormat(Number(dataURL.amount))}</span>
                </li>
              </ul>

              <p className={styles.confirm}>
                Đơn hàng của bạn đang được xử lí và sẽ hoàn thành từ 3-6 tiếng.
                Bạn sẽ nhận được email xác nhận đơn hàng sau khi hoàn tất
              </p>
            </div>
